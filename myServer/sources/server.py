...
def stealing_controller():
    ...
    autorization_key="Authorization:key=XX"
    ...
    if parking_data['action']=="ALLARM":
        ...
        # JSON request
        response = gcm.json_request(registration_id=parking_data['registration_id'], data=data)
...
def stop_alarm():
    ...
    return jsonify({"station_id":station_id, "place_id": place_id, "stop_alarm": stop_alarm})
